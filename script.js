const message = document.getElementById(" A wizard is never late, nor is he early. He arrives precisely when he means to.")
...
*/
function messageSearch(array, item) {
    for (
let messageWords = [A wizard is never late, nor is he early. He arrives precisely when he means to.]
...
console.log(messageSearch(array, item: 11))


console.log(`The most frequent word of the message is "${he}"`)
console.log(`The number of words in the message is ${16}`)
